        ...
        <div id="modal" class="modal">
            <div class="modal-content">
                ...
                <form id="addStudentForm" method="post" action="add_student.php">
                    ...
                    <input type="text" id="curso" name="curso" value="<?php echo htmlspecialchars($aluno['curso']) ?>" required disabled>

                    <label for="turma">Série:</label>
                    <input type="text" id="turma" name="turma" value="<?php echo htmlspecialchars($aluno['serie']) ?>" required disabled>
