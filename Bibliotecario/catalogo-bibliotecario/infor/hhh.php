    ...
    <div class="container">
        ...
        <div class="formulario">
            <form method="POST" action="update_livro.php">
                ...
                <input type="text" id="titulo_livro" name="titulo_livro" placeholder="NOME DO LIVRO"
                ...
                <div class="input-group-label">
                    <label for="ano_de_aquisicao" class="editar_label">ANO DE AQUISIÇÃO</label>
                    <label for="numero_de_registro" class="editar_label">NÚMERO DE REGISTRO</label>
                </div>
                <div class="input-group">

                    <input type="number" id="ano_aquisicao" name="ano_aquisicao" placeholder="ANO DE AQUISIÇÃO"
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="quantidade_estoque" name="quantidade_estoque"
                        value="<?php echo $totalLivros; ?> (<?php echo $livrosDisponiveis; ?> estão disponíveis para empréstimos)"
                        readonly>
                ...
                <div class="button-group">
                    <button type="submit" class="btn-enviar" onclick="return confirmarAtualizacao()"><i
                            class="fa-solid fa-check"></i> Enviar</button>
                    <a href="../">
