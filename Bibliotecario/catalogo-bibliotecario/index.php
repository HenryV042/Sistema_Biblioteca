...
function getBookCover($titulo)
{
    ...
    $stmt = $conn->prepare("SELECT imagem FROM livros WHERE titulo_livro = :titulo AND imagem IS NOT NULL ORDER BY imagem IS NULL, id DESC LIMIT 1");
        ...
        <div class="shop-images" id="search-results">
            ...
            if ($stmt->rowCount() > 0) {
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo '<script>console.log('. $imagem .')</script>';
