...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if (checkRegistrationNumber($conn, $registrationNumber)) {
            ...
            $sql = 'INSERT INTO livros (titulo_livro, autor, editora, ano_aquisicao, origem, local, genero, cdd, cdu, numero_registro, selo, imagem) VALUES (:bookName, :author, :publisher, :acquisitionYear, :origin, :location, :genre, :cdd, :cdu, :registrationNumber, :seal, :image)';
            $stmt = $conn->prepare($sql);
