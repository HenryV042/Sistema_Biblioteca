...
try {
    ...
    $query = "
    SELECT
        e.id AS id,  -- Adiciona o id dos empréstimos
...
<body>
    ...
    <div class="container">
        <div class="cabecario">
            ...
            <a href='gerar_pdf.php'><button class="print-button">RELATÓRIO</button></a>
        </div>
        <table id="booksTable">
            <thead>
                <tr>
            ...
            <tbody>
                <?php foreach ($emprestimos as $emprestimo): ?>
                    <tr>
                        ...
                        <td>
                            <a href="renew.php?id=<?php echo urlencode($emprestimo['id']); ?>" class="icon-button">
                                <i class="fa-regular fa-calendar"></i>
                            </a>
                        </td>
                        <td>
                            <a href="devolucao.php?id=<?php echo urlencode($emprestimo['id']); ?>" class="icon-button">
