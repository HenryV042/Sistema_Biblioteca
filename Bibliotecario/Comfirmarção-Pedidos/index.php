    ...
    <div class="container-pedidos">
        ...
        try {
            ...
            foreach ($pedidos as $pedido) {
                ...
                echo '<h2>' . htmlspecialchars($pedido['nome_completo']) . ' - ' . htmlspecialchars($pedido['sala_digitos']) . '</h2>';
                echo '<h3>' . htmlspecialchars($pedido['titulo_livro']) . '</h3>';
                echo '<h5>MATRÍCULA: ' . htmlspecialchars($pedido['matricula']) . '</h5>';
                echo '</div>';
                echo '<button class="btn-aceitar" data-id="' . htmlspecialchars($pedido['id']) . '" data-nome="' . htmlspecialchars($pedido['nome_completo']) . '" data-titulo="' . htmlspecialchars($pedido['titulo_livro']) . '" data-matricula="' . htmlspecialchars($pedido['matricula']) . '"><i class="fa-solid fa-check"></i> Aceitar o Pedido</button>';
                echo '</div>';
            }
